...
if __name__ == '__main__':
    ...
    frame['qos_total'] = (frame.msg_violadas / frame.total_msg)
    frame['qos_core'] = (frame.core_violadas / frame.total_msg)
    frame['qos_coletor'] = (frame.coletor_violadas / frame.total_msg)
