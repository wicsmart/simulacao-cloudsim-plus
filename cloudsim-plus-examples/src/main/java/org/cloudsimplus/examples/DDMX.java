...
public class DDMX {
    ...
    private DatacenterBroker broker0, broker1;
    private List<Vm> vmList;
    private List<Cloudlet> cloudletList0, cloudletList1;    
    ...
    public DDMX() {
        ...
        cloudletList0 = createCloudlets0();
        cloudletList1 = createCloudlets1();
  ...
  //      printResults();
    ...
    //    final List<Cloudlet> finishedCloudlets1 = broker0.getCloudletFinishedList();
        ...
        for (int i = 0; i < VMS; i++) {
            Vm vm =
                new VmSimple(i, 1000, VM_PES)
                    .setRam(1048).setBw(10000).setSize(100000)
     ...
     */
    private List<Cloudlet> createCloudlets0() {
    ...
    private List<Cloudlet> createCloudlets1() {
        ...
        for (int i = 0; i < CLOUDLETS; i++) {
            Cloudlet cloudlet =
                new CloudletSimple(i, CLOUDLET_LENGTH*100, CLOUDLET_PES)
                    .setFileSize(1024)
                    .setOutputSize(1024)
                    .setUtilizationModel(utilization);
            list.add(cloudlet);
